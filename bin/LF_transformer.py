...
# %%
#  A class for inserting factorizer token and data embedding for a column transformer:
...
#  A class for inserting factorizer token and data embedding for a row transformer:
...
#  A class for inserting CLS token for a CLS transformer:
